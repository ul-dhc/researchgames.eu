...
themeButton.addEventListener('click',()=>{root.dataset.theme=root.dataset.theme==='light'?'dark':'light';try{localStorage.setItem('rg-placeholder-theme',root.dataset.theme)}catch(e){}syncTheme()});syncTheme();
