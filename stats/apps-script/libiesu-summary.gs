// Replace the existing doGet with this version in the Livonian dashboard.
...
function doGet(e) {
  ...
  return HtmlService.createHtmlOutputFromFile("Dashboard")
    .setTitle("Lībiešu vietvārdu spēle – pētniecības dati")
...
function researchGamesUncachedSummary_(period) {
  ...
  try {
    ...
    const data = getDashboardData(periods[period || 'all'], '', '');
